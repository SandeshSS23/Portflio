      ...
      <Row>
        ...
        <Row>
          <Col md={6} className="contact-address">
            ...
            <p>
              {" "}
              <AiOutlineWhatsApp /> +91 7340414303
            </p>
          </Col>
          <Col md={6} className="contact-address">
            <h4>Email Address</h4>
        ...
        <Col md={12} className="home-about-social">
          ...
          <span>
            ...
            Node and Opensource Development.
          </span>
          <br />
          <p>
          ...
          <ul className="home-about-social-links">
            ...
            <li className="social-icons">
              <a
                href="https://www.instagram.com/sandesh_sahane_23/"
                target="_blank"
                rel="noreferrer"
                className="icon-colour home-social-icons"
              >
